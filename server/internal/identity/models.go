...
type User struct {
	...
	EmailLookup      *string `gorm:"size:64;uniqueIndex"`
...
type Role struct {
	...
	NormalizedName       string  `gorm:"size:100;not null"`
	NormalizedNameLookup *string `gorm:"size:64;uniqueIndex"`
	EncryptedProfile     []byte
