...
impl ApiTester {
    ...
    fn from_initial_state(
        ...
        let mut this = Self {
            ...
            script_console_session: None,
            script_console_session_key: None,
            script_console_reports: Vec::new(),
            mcp_script_console_generation: 0,
            mcp_script_console_operation_id: None,
            mcp_script_console_request_id: None,
            mcp_script_console_owned: false,
            ...
            cookie_values_visible: false,
            cookie_value_visibility: HashMap::new(),
            runtime,
            history,
            history_warning,
            history_writable,
