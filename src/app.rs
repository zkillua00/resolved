...
use crate::{
    ...
    core::{
        ...
        WebSocketReplay, WebSocketReplayDirection, WebSocketReplayFrame, WebSocketSavedMessage,
        WebSocketSignal, WebSocketWorkspace, Workspace, WorkspaceMutationError, WorkspaceProvider,
        WorkspaceProviderId, WorkspaceProviderRegistry, add_upstream_proxy_allowlist_entry,
        binary_preview, build_client_with_cookie_jar, build_upstream_client,
        build_upstream_execution_client, compare_replay_frames, create_upstream_collection,
        ...
        resolve_request, save_upstream_environment, template_variable_names,
        ...
        validate_automation_module_name, watch_upstream_changes,
    },
...
pub struct ApiTester {
    ...
    prepared_execution: Option<execution::PreparedExecution>,
    local_execution_limit_editor: Option<local_execution_limits::LocalExecutionLimitEditor>,
    ...
    script_console_session: Option<crate::core::ScriptConsoleSession>,
    script_console_session_key: Option<(u64, String)>,
    ...
    selected_cookie: Option<(String, String, String)>,
    cookie_values_visible: bool,
    cookie_value_visibility: HashMap<(String, String, String), bool>,
    runtime: Arc<Runtime>,
    history: RequestHistory,
    history_warning: Option<String>,
    history_writable: bool,
    persistence_io: persistence::PersistenceIoState,
    ...
    theme_editor_open_generation: u64,
